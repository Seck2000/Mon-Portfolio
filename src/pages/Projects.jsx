...
const Projects = () => {
  // Vos vrais projets récupérés depuis GitHub
  const projects = [
    {
      id: 1,
      title: "CineReserv",
      ...
      image: "/github-profile.png", // Image par défaut (votre profil)
      technologies: ["C#", "ASP.NET", "SQL Server"],
      githubLink: "https://github.com/Seck2000/CineReserv",
      demoLink: null // Pas de lien de démo pour l'instant
    },
    {
      id: 2,
          ...
          <div key={project.id} className="project-card">
            ...
            <div className="project-content">
              ...
              <div className="project-links">
                ...
                {project.demoLink && (
                  <a href={project.demoLink} target="_blank" rel="noopener noreferrer" className="btn-link btn-link-primary">
                    Démo Live
                  </a>
                )}
              </div>
